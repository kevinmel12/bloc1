...
|GET|POST|
|---|----|
|Demander des données au serveur, (qu'on peut apprecevoir danss l'URL en tant que paramètre de requête|a méthode POST permet d'envoyer les données au serveur|
